...
from transformers import UniSpeechModel, Wav2Vec2Processor
...
# Unispeech modelini ve processor'ı yükleme
# Huggingface sitesine kayıt olup token aldık ve bu token:"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"
model_identifier = 'facebook/unispeech-large-1500h-cv'
token = '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'
processor = Wav2Vec2Processor.from_pretrained(model_identifier)
model = UniSpeechModel.from_pretrained(model_identifier, use_auth_token=token)
