...
# Whisper modelini ve processor'ı yükleme
...
def extract_features(file_list, augment=False):
    ...
    for file in file_list:
        ...
        with torch.no_grad():
            # Burada decoder_input_ids veya decoder_inputs_embeds'i belirtmeliyiz
            decoder_input_ids = torch.tensor([[model.config.decoder_start_token_id]]).repeat(input_features.size(0), 1)
